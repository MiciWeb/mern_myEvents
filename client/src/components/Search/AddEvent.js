...
const AddEvent = ({ event_id, user_id, setCaroussel2, setCaroussel }) => {
    ...
    return (
        <div>
            ...
            <BsFillArrowLeftCircleFill className="left-arrow" onClick={() => { setCaroussel2(false); setCaroussel(true); }} />
            {console.log(user_id)}
                ...
                <>
                    <form className="form-contact" action="#">
                        ...
                        <div className="input-box message-box">
                            <textarea name="" placeholder="Description" onChange={(e) => setDescription(e.target.value)}></textarea>
                        </div>
